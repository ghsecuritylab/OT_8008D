...
u32 pinSet[3][8] = {
    ...
    if (On) {
		...
		if ((currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV8825_SUNNY_MIPI_RAW,currSensorName)))
			||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV8825_TRULY_MIPI_RAW,currSensorName))))
		{
        ...
        if(pinSetIdx == 0 || pinSetIdx == 2) {//disable sub
		  ...
		  || (currSensorName && (0 == strcmp(SENSOR_DRVNAME_S5K8AAYX_SUNNY_MIPI_YUV,currSensorName))))
	{
