...
#define GUP_SEARCH_FILE_TIMES       5			//modified by bbl,reduce determine times,because it is no use
#define UPDATE_FILE_PATH_2          "/data/goodix/_goodix_update_.bin"                          // GT913_1023.BIN
