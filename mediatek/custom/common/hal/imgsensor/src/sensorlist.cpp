...
MSDK_SENSOR_INIT_FUNCTION_STRUCT SensorList[] =
{
    ...
    RAW_INFO(OV8825_SUNNY_SENSOR_ID, SENSOR_DRVNAME_OV8825_SUNNY_MIPI_RAW,CAM_CALGetCalData), 
#endif

#if defined(OV8825_TRULY_MIPI_RAW)
    RAW_INFO(OV8825_TRULY_SENSOR_ID, SENSOR_DRVNAME_OV8825_TRULY_MIPI_RAW,CAM_CALGetCalData), 
#endif
    ...
    YUV_INFO(S5K8AAYX_SUNNY_MIPI_SENSOR_ID, SENSOR_DRVNAME_S5K8AAYX_SUNNY_MIPI_YUV,NULL), 
#endif
