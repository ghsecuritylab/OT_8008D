 ...
 *
 * 02 04 2013 kylin.xu
 * [JRD390926]porting P167_JRD390926_For_JRDSH75_CU_JB_ALPS.JB.MP.V1_P167_.tar.gz
 * Fix DLNA Bug
            ...
            case SWCTRL_RX_MDNS_FILTER:
                {
                    ...
                    if (ucOpt0 == SWCR_RX_MDNS_FILTER_CMD_STOP) {
                        ...
                        u4rxfilter = prAdapter->u4OsPacketFilter;						
                        //porting P167_JRD390926_For_JRDSH75_CU_JB_ALPS.JB.MP.V1_P167_.tar.gz BEGIN---QIHONG.XU@TCL.COM---Feb 04,2013
                        ...
                        //}
                        //else {
                        //porting P167_JRD390926_For_JRDSH75_CU_JB_ALPS.JB.MP.V1_P167_.tar.gz END---QIHONG.XU@TCL.COM---Feb 04,2013
                            u4rxfilter |= PARAM_PACKET_FILTER_ALL_MULTICAST;
                        }
                        fgUpdate = TRUE;
                    }
