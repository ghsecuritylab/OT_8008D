...
static void mtk_set_vbus(struct musb *musb, int is_on)
{
	...
	fan5405_config_interface_liao(0x02,0xae);   //mingquan.lai fix PR350237:Percentage of battery display abnormal,set charger output float voltage to 4.36V 20130101
    #elif defined(MTK_BQ24158_SUPPORT)
