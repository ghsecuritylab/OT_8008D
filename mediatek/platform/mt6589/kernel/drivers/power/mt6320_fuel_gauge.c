...
//// Internal API 
///////////////////////////////////////////////////////////////////////////////////////////
extern unsigned long turn_on_off_charging;	//add by tao.zhang. for factory charging test.2012-12-26
void fg_voltage_mode(void)
{
    if( upmu_is_chr_det()==KAL_TRUE && turn_on_off_charging) //modify by tao.zhang. for factory charging test.2012-12-26
    {
