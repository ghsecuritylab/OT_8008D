...
ifneq ($(strip $(MTK_EMMC_SUPPORT)),yes)
	...
	if [ -f $(MKTOPDIR)/$(VERSIONDEF) ]; then \
	  echo -n "#define PRELOADER_VER JRD_VERSION_MARK_" > $(MKTOPDIR)/mediatek/platform/mt6589/preloader/src/init/inc/version.h ;\
	  awk ' /PRELOADER_VER/ { print substr($$NF, 2, $(VERSIONLEN)) }' $(MKTOPDIR)/$(VERSIONDEF) >> $(MKTOPDIR)/mediatek/platform/mt6589/preloader/src/init/inc/version.h ;\
	fi
